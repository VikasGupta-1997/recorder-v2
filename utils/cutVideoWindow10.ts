async function cutVideoWindow10(ffmpeg, videoBlob, start, end, cut, duration, encode) {
  ...
  export function toBase64Window10(blob) {
  ...
  // export async function fixMetadataWindow10(ffmpeg, blob) {
  //   const data = new Uint8Array(await blob.arrayBuffer());
  //   ffmpeg.FS('writeFile', 'input.webm', data);
  //   await ffmpeg.run('-i', 'input.webm', '-c', 'copy', '-movflags', 'faststart', 'output.webm');
  //   const output = ffmpeg.FS('readFile', 'output.webm');
  ...
  export async function extractAudioWindow10(ffmpeg, videoBlob, outputFormat = "mp3") {
  ...
  export async function reencodeVideoWindow10(ffmpeg, blob) {
  ...
  export async function replaceVideoAudioWindow10(ffmpeg, videoBlob, audioBlob) {
  ...
  export default cutVideoWindow10;
