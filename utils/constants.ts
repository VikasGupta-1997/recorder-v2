...
const cutModeOptions = [
    ...
    { label: 'Export Uncut Audio', value: 'export_uncut_audio' },
    { label: 'Set Cuts To Silence', value: 'set_cuts_to_silence' }
]

const denoiseMethodOptions = [
    { label: 'Static: remove constant noise only', value: 'static' },
    { label: 'Dynamic: keep speech and music, remove everything else', value: 'dynamic' },
    { label: 'Speech Isolation: keep speech  , remove everything else', value: 'speech_isolation' }
]

const removeNoiseOptions = [
    { label: '100 db (full)', value: 100 },
    { label: '0ff', value: -1 },
    { label: '3db', value: 3 },
    { label: '6db (low) ', value: 6 },
    { label: '9db', value: 9 },
    { label: '12db (medium)', value: 12 },
    { label: '15db', value: 15 },
    { label: '18db', value: 18 },
    { label: '30db', value: 30 },
]
const removeBreathingOptions = [
    { label: '0ff', value: -1 },
    { label: '3dB', value: 3 },
    { label: '6dB (low)', value: 6 },
    { label: '9dB', value: 9 },
    ...
    { label: '15dB', value: 15 },
    { label: '18dB', value: 18 },
    { label: '24dB (high)', value: 24 },
    { label: '30dB', value: 30 },
    { label: '100dB (full)', value: 100 },
...
const normalizationMethodOptions = [
    { label: 'Program Loudness', value: 'program' },
    { label: 'Dialog Loudness', value: 'dialog' }
]

const filteringModeOptions = [
    { label: 'Adaptive high-pass filtering', value: 'hipfilter' },
    { label: 'Voice AutoEQ', value: 'autoeq' }
]
...
const musicSpeechClassifierOptions = [
    { label: 'On', value: 'on' },
    { label: 'All Speech', value: 'speech' },
    { label: 'All Music', value: 'music' },
]
...
const defaultAdvanceAuphonicState = {
    trackCuttingToggle: false,
    noiseReductionToggle: true,
    loudnessCorrectionToggle: true,
    filteringToggle: true,
    adaptiveLevelerToggle: true,
    trackCutting: {
        removeSilence: true,
        removeFiller: false,
    ...
    noiseReduction: {
        ...
        removeBreathing: removeBreathingOptions[0],
